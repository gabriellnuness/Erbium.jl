...
(β_abs, β_emis, τ21, τ3, diameter, NA, total_population) = optical_fiber(fiber)
...
* `total_population`:     Ions population in 1/m³
"""
function optical_fiber(fiber::String)
    ...
    elseif fiber == "m12"
        ...
        return (β_abs, β_emis, τ21, τ3, diameter)
