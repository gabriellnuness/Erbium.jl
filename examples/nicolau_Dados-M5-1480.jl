...
#### Dados da fibra
RL = 0.750#0001 #0.00001# # Refletividade no fim da fibra
R0 = 0.01#3
T = 273+27  #Temperatura em kelvin
Ksigma = 0.9#0.85 # Datasheet FiberCore para M12 0.9
Z0 = 1.0
...
L = 15 # metros - comprimento da fibra dopada com érbio ###

### Dados da bomba
  I_980 = 0 #Corrente do laser 980 nm
  P0_980  = -0.025+0.65*I_980  #40e-3 #Potência da bomba em watt ( 980 nm)
    if P0_980 <0
       P0_980 = 0 
    end
  #I_1480 = 0 #Corrente do laser 1480 nm
  P0_1480 = -0.009+0.153*I_1480 #20e-3 #Potência da bomba em watt (1480 nm)
    if P0_1480 < 0 
      P0_1480 = 0  
    end 
